...
export class TokenAmount {
    ...
    constructor(_amountNumber, token, toAmountOnChain, _showDecimals, chainId) {
        let tokenConfig = token && typeof token === 'string' ? getToken(token, chainId) : token;
        let amountNumber =
        ...
        let showDecimals = _showDecimals === undefined ? DEFAULT_TOKEN_AMOUNT_SHOW_DECIMALS : _showDecimals;
        ...
        if (!toAmountOnChain) {
            ...
            this.amount = new Amount(n, showDecimals);
        } else {
            this.amount = new Amount(amountNumber, showDecimals);
